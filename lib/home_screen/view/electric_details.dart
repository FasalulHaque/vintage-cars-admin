...
import 'package:vintagecars_seller/home_screen/bloc/delete_bloc.dart';
...
class _ElectricDetailsState extends State<ElectricDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    final vehicleColors = widget.electricAxis['colors'] as List;
                ...
                Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return colorDots(
                          int.parse(vehicleColors[index].toString()));
                    },
                  ),
                ),
                const SizedBox(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                widget.electricAxis['battery_capacity']
                                    .toString(),
                                style: const TextStyle(
                                  fontSize: 13,
                                  fontWeight: FontWeight.w500,
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    widget.electricAxis['driving_range']
                                        .toString(),
                                    style: const TextStyle(
                                      fontSize: 13,
                                      fontWeight: FontWeight.w500,
                    ...
                    children: [
                      ...
                      IconButton(
                        onPressed: () => deleteBloc.add(
                          DeleteOptionEvent(
                            eleid: widget.electricAxis['car_id'].toString(),
                          ),
                        ),
                        icon: const Icon(
                          Icons.delete,
